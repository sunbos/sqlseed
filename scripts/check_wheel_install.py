...
def main() -> None:
    ...
    with tempfile.TemporaryDirectory(prefix="sqlseed-wheel-smoke-") as directory:
        ...
        try:
            ...
            def request(path: str, payload: dict[str, str] | None = None, origin: str | None = None):
            ...
            print(json.dumps({"wheel_imports": True, "rows": count, "web": "ready", "components": components}))
        finally:
            supervisor.stop()
