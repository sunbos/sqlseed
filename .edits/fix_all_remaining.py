...
Handles MySQL removal, CLI removal from core tree, mcp-server extras correction,
architecture diagram update, and minor AGENTS.md fixes.
"""
...
edit(f"{ROOT}/README.md",
     ...
     "| `sqlseed-ai[mcp]` | + mcp>=1.0,<2 | AI MCP server (4 Gemma 4 tools) |")
...
edit(f"{ROOT}/README.zh-CN.md",
     ...
     "| `sqlseed-ai[mcp]` | + mcp>=1.0,<2 | AI MCP 服务器（4 个 Gemma 4 工具） |")
...
# ============================================================
# docs/architecture.zh-CN.md §10 MCP rewrite
# ============================================================
...
# ============================================================
# src/sqlseed/generators/AGENTS.md base_provider line
# ============================================================
...
# ============================================================
# plugins/sqlseed-ai/AGENTS.md pyproject line
# ============================================================
