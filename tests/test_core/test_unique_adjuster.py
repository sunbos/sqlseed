...
class TestUniqueAdjuster:
    ...
    def test_adjust_string_with_digits_charset(self):
        mapper = ColumnMapper()
        adjuster = UniqueAdjuster(mapper)
        specs = {
            "code": GeneratorSpec(
    ...
    def test_adjust_string_with_alpha_charset(self):
        mapper = ColumnMapper()
        adjuster = UniqueAdjuster(mapper)
        specs = {
            "code": GeneratorSpec(
    ...
    def test_adjust_integer_range_already_sufficient(self):
        mapper = ColumnMapper()
        adjuster = UniqueAdjuster(mapper)
    ...
    def test_adjust_non_unique_column_unchanged(self):
        mapper = ColumnMapper()
        adjuster = UniqueAdjuster(mapper)
    ...
    def test_adjust_column_not_in_specs(self):
        mapper = ColumnMapper()
        adjuster = UniqueAdjuster(mapper)
        specs = {"name": GeneratorSpec(generator_name="string", params={"min_length": 1, "max_length": 50})}
